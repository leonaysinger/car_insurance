from app.core.services.premium_calculator_service import calculate_premium
...
def test_calculate_premium_valid_input():
    response = calculate_premium(sample_car_details)
...
def test_calculate_premium_without_location():
    ...
    response = calculate_premium(car_details_no_location)
